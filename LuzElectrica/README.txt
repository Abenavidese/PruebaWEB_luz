...
a persistence unit "LuzElectricaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "LuzElectrica/pom.xml":
...
artifact ("LuzElectrica.war") is already built. You can build
